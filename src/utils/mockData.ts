...
export const mockJobOrders: JobOrder[] = [
  {
    ...
    containers: [
      ...
      createContainer(1, '40ft', 28, true, 'A2-0', -4, -24),
      createContainer(2, '20ft', 15, false, 'B1-0', 0, -24),
      createContainer(3, '20ft', 22, false, 'C1-0', 4, -24),
      createContainer(4, '40ft', 30, true, 'C2-0', 8, -24),
      createContainer(5, '20ft', 12, false, 'D1-0', -8, -22),
      createContainer(6, '40ft', 25, true, 'E1-0', -4, -22),
      createContainer(7, '20ft', 20, false, 'A3-0', 0, -22),
      createContainer(8, '20ft', 16, false, 'B3-0', 4, -22),
      createContainer(9, '40ft', 32, true, 'C3-0', 8, -22),
    ],
  },
  {
    id: 'JOB-002',
    ...
    containers: [
      ...
      createContainer(5, '40ft', 22, false, 'C2-0', -8, -22),
      createContainer(6, '20ft', 8, false, 'B2-0', -4, -22),
      createContainer(7, '20ft', 24, false, 'E2-0', 0, -22),
      createContainer(8, '40ft', 30, true, 'A3-0', 4, -22),
      createContainer(9, '20ft', 15, false, 'C3-0', 8, -22),
    ],
  },
];
